...
def upload_view(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            project_id = (form.cleaned_data.get("project_id") or "").strip()
            ...
            try:
                save_upload(uploaded_file, str(zip_path))
                ...
                return render(
                    ...
                    {
                        "form": form,
                        "error": f"Could not process ZIP file: {exc}",
                    },
                )
            ...
            if not json_files:
                ...
                return render(
                    ...
                    {
                        "form": form,
                        "error": "No JSON files were found inside a Workflows folder.",
                    },
                )
